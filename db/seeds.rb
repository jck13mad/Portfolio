...
project_data = [
    {
        ...
        image_url: "covid-19-updates.png",
        label: "cli gem ruby",
...

    {
        ...
        image_url: "hidden-eats.png",
        label: "Ruby Rails CRUD Comment Javascript Bootstrap SQL",
